...
const RENAISSANCE = {
  ...
  encounters: [
    ...
    { id: 'E_R_CAMP_INTRO', roomId: 'R01_SIEGE_CAMP',
      ...
      waves: [{ ids: ['lansquenet', 'pikeman', 'musketeer'] }],
      reward: { coins: 10 } },
    { id: 'E_R_TRENCH_LOW', roomId: 'R02_TRENCH_HUB',
      trigger: { x: 40, y: 18, w: 20, h: 6 }, gates: [],
      waves: [{ ids: ['lansquenet', 'pikeman', 'musketeer'] }, { ids: ['bombardier', 'musketeer', 'pikeman'] }],
      reward: { coins: 16 } },
    ...
    { id: 'E_R_BARRICADE_GAUNTLET', roomId: 'R03_BARRICADE_GAUNTLET',
      ...
      waves: [{ ids: ['lansquenet', 'pikeman', 'musketeer'] }, { ids: ['bombardier', 'cannoneer', 'pikeman'] }],
      reward: { coins: 18 } },
    ...
    { id: 'E_R_WORKSHOP_ELITE', roomId: 'R07_SIEGE_WORKSHOP',
      ...
      waves: [{ ids: ['gear_servitor', 'gear_servitor', 'lansquenet'] },
              { ids: ['musketeer', 'musketeer', 'cannoneer'] },
    ...
    { id: 'E_SEC_R_TUNNEL_GAUNTLET', roomId: 'SEC_RENAISSANCE_TUNNELS',
      ...
      waves: [{ ids: ['lansquenet', 'pikeman', 'musketeer', 'powder_saboteur', 'bombardier'] }],
      reward: { coins: 18 } },
    { id: 'E_SEC_R_TUNNEL_KEGROOM', roomId: 'SEC_RENAISSANCE_TUNNELS',
      trigger: { x: 114, y: 28, w: 16, h: 4 }, gates: [],
      waves: [{ ids: ['musketeer', 'musketeer', 'cannoneer', 'powder_saboteur'] }],
      reward: { coins: 18 } },
    ...
    { id: 'E_SEC_R_TOWER_SWARM', roomId: 'SEC_RENAISSANCE_TOWER',
      ...
      waves: [{ ids: ['pikeman', 'pikeman', 'lansquenet', 'musketeer', 'musketeer', 'musketeer',
  ...
  spawns: [
    ...
    { tx: 118, ty: 22, id: 'lansquenet' },    // barricade
...
const DIESEL = {
  ...
  encounters: [
    ...
    { id: 'E_D0_GAUNTLET', roomId: 'D0_SURFACE',
      ...
      waves: [{ ids: ['trench_soldier', 'trench_soldier', 'flamethrower'] },
              { ids: ['flamethrower', 'mortar_crew', 'trench_soldier'] }],
      reward: { coins: 18 } },
    ...
    { id: 'E_D2_GAUNTLET', roomId: 'D2_GALLERIES',
      ...
      waves: [{ ids: ['armored_trooper', 'trench_soldier', 'mortar_crew'] },
              { ids: ['flamethrower', 'armored_trooper', 'trench_soldier'] }],
      reward: { coins: 22 } },
    { id: 'E_D2_SEC_GALLERY', roomId: 'D2_SEC_GALLERY',
      trigger: { x: 6, y: 98, w: 20, h: 8 }, gates: [],
      waves: [{ ids: ['armored_trooper', 'armored_trooper', 'mortar_crew', 'diesel_tunnel_stalker'] },
    ...
    { id: 'E_D3_SEC_HORDE', roomId: 'D3_SEC_HORDE_CAPTAIN',
      ...
      waves: [{ ids: ['trench_soldier', 'trench_soldier', 'flamethrower', 'armored_trooper', 'mortar_crew'] }],
      reward: { coins: 24 } },
