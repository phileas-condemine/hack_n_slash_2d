"""One-off slicer for assets/raw/gen_minions/r4_armored_captain_v2_sheet.png - redesigned
'armored_captain' art (2026-07-29): the previous sprite was an ornate medieval knight with a
heraldic lion shield, visually near-identical to R2's temple_guardian. Replaced with a Renaissance
mercenary captain (burgonet + plume, blackened cuirass, sash, rapier, small round buckler) sharing
the pikeman/musketeer/bombardier material language instead.
...
SRC = os.path.join(ROOT, 'assets', 'raw', 'gen_minions', 'r4_armored_captain_v2_sheet.png')
DST = os.path.join(ROOT, 'assets', 'enemies', 'states')
NAMES = ['armored_captain_neutral', 'armored_captain_windup', 'armored_captain_attack']
