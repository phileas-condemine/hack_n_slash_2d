"""One-off slicer for assets/raw/gen_minions/r4_sapper_sheet.png (new dedicated art for
'powder_saboteur' - it previously shared the musketeer sprite via AR.ENEMY_FALLBACK, which read
as a duplicate rather than a distinct saboteur - cf. TODO.md era-coherence audit, 2026-07-29).
...
SRC = os.path.join(ROOT, 'assets', 'raw', 'gen_minions', 'r4_sapper_sheet.png')
DST = os.path.join(ROOT, 'assets', 'enemies', 'states')
NAMES = ['powder_saboteur_neutral', 'powder_saboteur_windup', 'powder_saboteur_attack']
