"""One-off slicer for assets/raw/gen_minions/r3_ronin_sheet.png (new fallen-samurai 'ronin' art,
replacing the Renaissance-looking sprite previously at this id - cf. TODO.md era-coherence audit,
2026-07-29). The old art was renamed to lansquenet_* and moved to the Renaissance roster.

Same approach as slice_cannoneer_sheet.py: clean 3-pose vertical stack, no caption text, so
"content" = any non-green pixel. Run once, then delete/ignore.
"""
import os
from PIL import Image

ROOT = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
SRC = os.path.join(ROOT, 'assets', 'raw', 'gen_minions', 'r3_ronin_sheet.png')
DST = os.path.join(ROOT, 'assets', 'enemies', 'states')
NAMES = ['ronin_neutral', 'ronin_windup', 'ronin_attack']
